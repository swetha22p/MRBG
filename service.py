    ...
    try:
        ...
        if HAS_CONSTRUCTION_DATA:
            if flag_conj or flag_disjunct:
                processed_words = process_construction_conj_disjunct(processed_words,root_words, construction_data, depend_data, gnp_data, index_data,conj_concept)
        ...
        if has_changes:
            ...
            if HAS_CONSTRUCTION_DATA:
                if flag_conj or flag_disjunct:
                    processed_words = process_construction_conj_disjunct(processed_words, construction_data, depend_data, gnp_data,index_data,conj_concept)
                if flag_span:
                    processed_words = process_construction_span(processed_words, construction_data, index_data)
                if flag_rate:
                    processed_words = process_construction_rate(processed_words, construction_data,index_data)
